...
* Metoda OnModelCreating je otvorena za modifikaciju
* kada bi primjerice mjenjali shemu baze podataka
* 
* OnModelCreating -> dio Convention over Configuration design pattern-a
* 
*  
 */
